...
const EditFounder = () => {
    ...
    const getFounder = async () => {
        console.log('load');
        const response = await dispatch(loadsinglefounder(fid))
        console.log(response.payload);
        setFounder(response.payload.founderDetails)
    }
    ...
    const handleForm = async (input, e) => {
        ...
        const response = await dispatch(updatefounder({ formData, fid }));
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                <h1>
                                    <b>MEMBER DETAILS UPDATION FORM</b>
                                </h1>
                            </div>
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    ...
                                    <li className="breadcrumb-item active">Edit Founder</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="card card-primary">
                                    <div className="card-header">
                                        <h3 className="card-title">Form To Edit Member</h3>
                                    </div>
                                    {/* <!-- /.card-header --> */}
                                    {/* <!-- form start --> */}
                                    <form
                                        ...
                                        <div className="card-body">
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    defaultValue={founder && founder.name}
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    defaultValue={founder && founder.desc}

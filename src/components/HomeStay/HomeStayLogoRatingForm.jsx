...
import { homestaylogoratinglist, getAllHomeStay, updatehomestaylogorating, addhomepackagelogorating } from '../../redux/Slice'
    ...
    const handleForm = async (input, e) => {
        ...
        if (type === 'text') {
            ...
            if (response.payload.status == 1) {
                navigate('/homestaylogoratinglist')
            }
        }
        else if (type === 'logo') {
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                {
                                    logoratingId ? <h4><b>LOGO & RATING UPDATION FORM</b></h4>
                                        : <h4><b>LOGO & RATING INSERTION FORM</b></h4>
                                }
                            </div>
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    <li className="breadcrumb-item"><Link to='/home'>Home</Link></li>
                                    <li className="breadcrumb-item "><Link to='/homestaylogoratinglist'>Logo Rating List</Link></li>
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="card card-primary">
                                    <div className="card-header">
                                        ...
                                        {
                                            logoratingId ? <h4><b>Form To Update Logo Rating Document</b></h4>
                                                : <h4><b>Form To Create New Logo Rating Document</b></h4>
                                        }
                                    </div>
                                    {/* <!-- /.card-header --> */}
                                    {/* <!-- form start --> */}
...
export default HomeStayLogoRatingForm

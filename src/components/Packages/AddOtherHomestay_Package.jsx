...
const AddOtherHomestay_Package = () => {
...
if(res.payload.status == 1){
    navigate('/package/otherhomestays')    
}
}
            ...
            <div className="row mb-2">
              ...
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  ...
                  <li className="breadcrumb-item">
                    <Link to="/package/otherhomestays">Other Homestays</Link>
                  </li>
                </ol>
              </div>
            </div>
...
export default AddOtherHomestay_Package;

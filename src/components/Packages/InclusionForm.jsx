...
import { AllPackages, addhomestaypackagegallery, addinclusion } from '../../redux/Slice'
...
const InclusionForm = () => {
    ...
    const handleForm = async (input, e) => {
        ...
        const response = await dispatch(addinclusion(formData))
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="card card-primary">
                                    <div className="card-header">
                                        <h3 className="card-title">Form To Create New Inclusion Item</h3>
                                    </div>
                                    {/* <!-- /.card-header --> */}
                                    {/* <!-- form start --> */}

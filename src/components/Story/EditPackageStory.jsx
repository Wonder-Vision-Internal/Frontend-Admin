          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1><b>PACKAGE STORY UPDATION FORM</b></h1>
              </div>
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  <li className="breadcrumb-item"><Link to='/home'>Home</Link></li>
                  <li className="breadcrumb-item "><Link to='/packagestories'>Package Stories</Link></li>
                  <li className="breadcrumb-item active">Edit Package Story</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div className="col-md-12">
                ...
                <div className="card card-primary">
                  <div className="card-header">
                    <h3 className="card-title">Form To Edit Package Story</h3>
                  </div>
                  {/* <!-- /.card-header --> */}
                  {/* <!-- form start --> */}
...
export default EditPackageStory

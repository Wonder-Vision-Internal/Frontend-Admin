...
import { AllPackages, addstories, getAllHomeStay } from '../../redux/Slice'
import { Link, useNavigate, useParams } from 'react-router-dom'
import { useForm } from 'react-hook-form'
import { useDispatch } from 'react-redux'

const PackageStoryForm = () => {
  ...
  const getpackagenames = async () => {
    ...
    console.log('home stay names', response.payload.packages)
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1><b>PACKAGE STORY CREATION FORM</b></h1>
              </div>
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  <li className="breadcrumb-item"><Link to='/home'>Home</Link></li>
                  <li className="breadcrumb-item "><Link to='/packagestories'>Package Stories</Link></li>
                  <li className="breadcrumb-item active">Add Package Story</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div className="col-md-12">
                ...
                <div className="card card-primary">
                  <div className="card-header">
                    <h3 className="card-title">Form To Create New Package Story</h3>
                  </div>
                  {/* <!-- /.card-header --> */}
                  {/* <!-- form start --> */}
...
export default PackageStoryForm

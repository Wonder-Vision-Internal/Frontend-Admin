...
import { AllPackages, deletestory, getAllHomeStay, getfilteredstories, gettestimonialstories } from '../../redux/Slice'




const PackageStoryList = () => {
    ...
    const getpackagenames = async () => {
        console.log('ps',post_type);
        const response = await dispatch(AllPackages())
        console.log('package names', response)
    ...
    const filterstories = async () => {
        if (filter.slug) {
            ...
            setPkgName(response.payload.details[0].title)
                                    ...
                                    {/* <!-- /.card-header --> */}
                                     ...
                                     <div className="row" style={{
                                        ...
                                        <div className='col-md-2'>
                                            ...
                                            <Link to='/stories/packagestoryform'>
                                            <button type="button" className="btn bg-gradient-primary"
                                                    ...
                                                    {stories.map((data, index) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td >
                                                             ...
                                                             <td >
                                                             <Link to={`/stories/loadsinglepackagestory/${data._id}`}><i className='fas fa-pen fas'></i></Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                             <i className='fas fa-trash' onClick={() => handleDelete(data._id)}></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                         </td>}
                                                        </tr>
                                                    ))}
...
export default PackageStoryList
